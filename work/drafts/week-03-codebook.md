...
File order in the page is deliberately scrambled — cards are ordered by a hash of their source
slug, which is unrelated to the coding — so that reading the page source reveals no grouping.
...
| `c1-02` | NAS1 | disagree, denominator-bearing | [`2026-03-11-allen-mcdonald-how-well-can-ai-do-strategy-simulation-benchmark`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-03-11-allen-mcdonald-how-well-can-ai-do-strategy-simulation-benchmark) |
| `c1-03` | NAS2 | disagree, denominator-bearing | [`2025-06-12-spracklen-package-hallucinations-code-generating-llms`](https://businessdatasolutions.github.io/ai-wiki/sources/2025-06-12-spracklen-package-hallucinations-code-generating-llms) |
| `c1-04` | AS3 | agree, denominator-bearing | [`2025-06-02-belcak-nvidia-small-language-models-future-agentic-ai`](https://businessdatasolutions.github.io/ai-wiki/sources/2025-06-02-belcak-nvidia-small-language-models-future-agentic-ai) |
| `c1-05` | AW1 | agree, selected on outcome | [`2026-08-11-huang-sequoia-own-your-intelligence-sovereign-ai`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-08-11-huang-sequoia-own-your-intelligence-sovereign-ai) |
...
| `c1-10` | NAW1 | disagree, selected on outcome | [`2026-06-12-aws-leaders-guide-advanced-team-structures-agentic-world`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-06-12-aws-leaders-guide-advanced-team-structures-agentic-world) |
| `c1-11` | NAW3 | disagree, selected on outcome | [`2026-09-14-google-cloud-agent-factory-agent-harnesses-explained`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-09-14-google-cloud-agent-factory-agent-harnesses-explained) |
| `c1-12` | NAW4 | disagree, selected on outcome | [`2025-05-06-jassy-amazon-agility-ai-strategy-changing-role-of-managers`](https://businessdatasolutions.github.io/ai-wiki/sources/2025-05-06-jassy-amazon-agility-ai-strategy-changing-role-of-managers) |
| `c1-13` | AW2 | agree, selected on outcome | [`2026-07-10-hugging-face-ceo-companies-done-renting-their-ai`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-07-10-hugging-face-ceo-companies-done-renting-their-ai) |
| `c1-14` | AS1 | agree, denominator-bearing | [`2025-07-13-patil-berkeley-function-calling-leaderboard`](https://businessdatasolutions.github.io/ai-wiki/sources/2025-07-13-patil-berkeley-function-calling-leaderboard) |
| `c1-15` | AS4 | agree, denominator-bearing | [`2026-09-07-yc-paper-club-why-the-harness-matters-more-than-the-model`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-09-07-yc-paper-club-why-the-harness-matters-more-than-the-model) |
...
| `c2-02` | NAS4 | disagree, denominator-bearing | [`2026-06-25-raboresearch-ai-it-zakelijke-dienstverlening`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-06-25-raboresearch-ai-it-zakelijke-dienstverlening) |
| `c2-03` | AW2 | agree, selected on outcome | [`2026-02-18-lyft-customer-support-with-claude`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-02-18-lyft-customer-support-with-claude) |
| `c2-04` | NAS2 | disagree, denominator-bearing | [`2026-04-28-dellacqua-jagged-technological-frontier`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-04-28-dellacqua-jagged-technological-frontier) |
| `c2-05` | AS1 | agree, denominator-bearing | [`2026-04-28-brynjolfsson-li-raymond-generative-ai-at-work`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-04-28-brynjolfsson-li-raymond-generative-ai-at-work) |
...
| `c2-07` | AS4 | agree, denominator-bearing | [`2026-05-07-anthropic-economic-index-5-learning-curves`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-05-07-anthropic-economic-index-5-learning-curves) |
| `c2-08` | NAW2 | disagree, selected on outcome | [`2026-04-25-masad-replit-ceo-only-two-jobs-left`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-04-25-masad-replit-ceo-only-two-jobs-left) |
...
| `c2-12` | NAW4 | disagree, selected on outcome | [`2026-06-19-lopopolo-ai-native-devcon-harness-engineering`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-06-19-lopopolo-ai-native-devcon-harness-engineering) |
| `c2-13` | AS2 | agree, denominator-bearing | [`2025-10-05-patwardhan-et-al-openai-gdpval`](https://businessdatasolutions.github.io/ai-wiki/sources/2025-10-05-patwardhan-et-al-openai-gdpval) |
...
| `c2-15` | AW1 | agree, selected on outcome | [`2026-07-14-khan-academy-ceo-the-real-ai-opportunity-is-in-boring-industries-sal-khan`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-07-14-khan-academy-ceo-the-real-ai-opportunity-is-in-boring-industries-sal-khan) |
| `c2-16` | NAW3 | disagree, selected on outcome | [`2026-05-27-scheffer-de-ondernemer-helloprint-ai-rebuild-from-day-zero`](https://businessdatasolutions.github.io/ai-wiki/sources/2026-05-27-scheffer-de-ondernemer-helloprint-ai-rebuild-from-day-zero) |
...
## Two things to brief, and one to check

- **Deck 1, NAS4 — AI Index 2025.** The report is 457 pages of graphics and only its summary page
  yields text, so the quotation is from that page. The sentence *after* the one quoted reads
  *"Open-weight models are closing the gap with closed models, reducing the performance difference
  from 8% to just 1.7% on some benchmarks in a single year"* — which leans the other way. The card
  is coded on cost, where the source is unambiguous, but a participant who opens the link will
  meet both. Brief it rather than be ambushed by it.
- **Deck 1, NAW cell.** Three of its four cards are Amazon, as the candidate-claims document
  already records. The rent-side case in this corpus is made almost entirely by one cloud vendor.
- **Deck 2, NAW3 — HelloPrint.** The wiki holds a PDF capture of the article, so the quotation is
  verbatim, and the link points at the original as SM-11 requires. But subtask 0.6 wants every
  source *openable and free*, and nobody has yet confirmed the article opens without a DPG
  subscription. **Check this before the session.** If it is metered the card fails however well it
  fits, and Nishar & Nohria comes back off the bench. Note also that the *~100 to 18* figure is
  the wiki's tag, not the article's text, and is not quoted on the card.

...
The exercise students do at home this week, alone, before the week 4 session. Say what it costs them (about 25 minutes and a laptop) and that the team number only sets the order of the two rounds. Say nothing about what the two rounds differ in: the comparison only works if they meet it cold. Their results come back in week 4, as one picture of the whole cohort.
